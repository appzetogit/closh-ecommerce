...
async function run() {
    ...
    // 2. Make sure order is in processing state and unassigned
    ...
    console.log('Reset order status to processing and unassigned.');
    ...
    if (!order) {
        console.log('❌ Simulated accept failed: Order not found or already assigned!');
    } else {
